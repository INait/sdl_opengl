...
void MatrixMath::matrixMult4x4Column(GLfloat* result, GLfloat* m1, GLfloat* m2)
{
	for (int i = 0; i < 16; i++) {
		result[i] = 0.0f;
	}
...
void MatrixMath::makeTranslate(GLfloat* result, GLfloat x, GLfloat y, GLfloat z)
{
	makeIdentity(result);
	result[3] = x;
	result[7] = y;
...
void MatrixMath::makeRotateX(GLfloat* result, GLfloat rotation)
{
	makeIdentity(result);
...
void MatrixMath::makeRotateY(GLfloat* result, GLfloat rotation)
{
	makeIdentity(result);
...
void MatrixMath::makeRotateZ(GLfloat* result, GLfloat rotation)
{
	makeIdentity(result);
...
void MatrixMath::makeScale(GLfloat* result, GLfloat x, GLfloat y, GLfloat z)
{
	makeIdentity(result);
	result[0] = x;
	result[5] = y;
